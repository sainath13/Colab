...
return(
 ...
 <Image
 style = {{width: 70, height: 70, borderRadius: 35, borderColor: '#fefefe', borderWidth: 2}}
 source = {!this.state.fetching ? {uri : this.props.profileData.basic_data.profile_pic_link} : require('../images/new.jpg')}
 />
 </View>
...
<View style={{flexDirection : 'row'}}>
 ...
 {!this.state.fetching ? this.props.profileData.basic_data.business_email : null }
 </Text>
 </View>
 </View>
 :
